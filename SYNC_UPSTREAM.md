...
[![Sync with Upstream](https://img.shields.io/badge/Sync%20with-Upstream-blue?style=for-the-badge&logo=github)](https://github.com/ship-kit/delete-1223a/compare/main...lacymorrow:shipkit:main)
...
```bash
gh repo sync ship-kit/delete-1223a --source lacymorrow/shipkit
```
...
2. Click "Compare" or go to: https://github.com/ship-kit/delete-1223a/compare/main...lacymorrow:shipkit:main
